...
<div class="aec aec-widget aec-past-events" id="<?php echo $widget_id; ?>">
    	...
    	<div class="row aec-no-margin">
            ...
            <?php } ?>     
                ...
                <?php if( $show_date ) : ?>
             	...
             	<?php 
					if( ! empty( $general_settings['has_categories'] ) && $show_category ) { 
						...
						if( ! empty( $categories ) ) {
							...
							echo '<p class="aec-no-margin-bottom text-muted"><span class="glyphicon glyphicon-folder-open"></span> '.implode( ', ', $meta ).'</p>';
						}
					}
				?>
