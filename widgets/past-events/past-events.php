 ...
 * @subpackage    another-events-calendar/widgets/past-events
 */
...
/**
 * AEC_Widget_Past_Events Class
 *
 * @since    1.7.0
 */
class AEC_Widget_Past_Events extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array( 
			'classname'   => 'aec-widget-past-events',
			'description' => __( 'Display past events.', 'another-events-calendar' ),
		);
		
		parent::__construct( 'aec-widget-past-events', __( 'Past Events', 'another-events-calendar' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		if( $aec_query->have_posts() ) {
			...
			include AEC_PLUGIN_DIR.'widgets/past-events/views/widget.php';
	...
	public function form( $instance ) {
		...
		$title = isset( $instance['title'] ) ? $instance['title'] : __( 'Past Events', 'another-events-calendar' );
		...
		include AEC_PLUGIN_DIR.'widgets/past-events/views/form.php';	  
...
add_action( 'widgets_init', create_function( '', 'register_widget("AEC_Widget_Past_Events");' ) );