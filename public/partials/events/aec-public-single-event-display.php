        ...
        <div class="col-md-3">
        	...
        	<div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php if( ! empty( $general_settings['has_categories'] ) && ! empty( $categories) ) : ?>
                    ...
                    <?php endif; ?>
                  	...
                  	<?php if( ! empty( $general_settings['has_tags'] ) && ! empty( $tags ) ) :?>
            ...
            <!-- Organizer meta box -->
          	<?php if( ! empty( $general_settings['has_organizers'] ) && ! empty( $organizers ) ) : ?>
                <div class="panel panel-default">
                    <div class="panel-heading">
            ...
            <!-- Venue meta box -->
            <?php if( ! empty( $general_settings['has_venues'] ) ) { ?>
