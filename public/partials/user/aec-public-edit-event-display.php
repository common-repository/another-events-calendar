...
<div class="aec aec-event-form">
	<form method="post" action="<?php echo aec_event_form_page_link(); ?>" class="form-vertical" enctype="multipart/form-data" data-toggle="validator" role="form">
        ...
        <div class="panel panel-default form-horizontal"> 
            ...
            <div class="panel-body">
            	<?php  if( ! empty( $general_settings['has_categories'] ) && aec_current_user_can( 'edit_aec_event' ) ) : ?>
                    <div class="form-group">
       	...
       	<div class="panel panel-default form-horizontal">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
          		...
          		<?php if( ! $event_id && ! empty( $general_settings['has_recurring_events'] ) && aec_current_user_can( 'edit_aec_event' ) ) : ?>
                	<div class="form-group">
        ...
        <!-- Event Venue -->
        <?php if( ! empty( $general_settings['has_venues'] ) && aec_current_user_can( 'edit_aec_venue' ) ) : ?>
            <div class="panel panel-default form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="venue_id" id="aec-venues" class="form-control">
                                ...
                                <?php
                                    $venues   = get_posts( array( 'post_type' => 'aec_venues', 'posts_per_page' => -1 ,'orderby' => 'title', 'order' => 'ASC' ) );
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <div class="aec-map embed-responsive-item" data-default_location="<?php echo $default_location; ?>" data-type="form">
        ...
        <!-- Event Organizer -->
        <?php if( ! empty( $general_settings['has_organizers'] ) && aec_current_user_can( 'edit_aec_organizer' ) ) : ?>
            <div class="panel panel-default form-horizontal">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="aec-multi-checkbox">
                                <?php
                                    $organizers_list = get_posts( array( 'post_type' => 'aec_organizers', 'posts_per_page' => -1 ,'orderby' => 'title', 'order' => 'ASC' ) );
                    ...
                    <div id="aec-organizer-fields" style="display: none;">
                        <div class="aec-organizer-fields">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"></label>
                                <div class="col-sm-9">
                                   <h3 class="aec-organizer-group-id bg-success"></h3>
                                </div>
                            </div>
