...
class AEC {
	...
	private function load_dependencies() {
		...
		require_once AEC_PLUGIN_DIR . 'public/class-aec-public-map.php';
	...
	private function define_public_hooks() {
		...
		// implement a filter for the post link title
		...
		// Hooks specific to map page
		$plugin_map = new AEC_Public_Map();
