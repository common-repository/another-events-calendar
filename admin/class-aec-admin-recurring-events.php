...
class AEC_Admin_Recurring_Events {
	 ...
	 * @param    array     $meta    Post Meta.
 	 */
	public function process_daily_events( $post, $meta ) {
	 ...
	 * @param    int       $occurences    Number of Occurences.
 	 */
	public function process_weekly_events( $post, $meta, $start_date = '', $occurences = 0 ) {
	 ...
	 * @param    int       $occurences    Number of Occurences.
 	 */
	public function process_monthly_events( $post, $meta, $start_date = '', $occurences = 0 ) {
	...
	public function manage_posts_columns( $columns ) {
		...
		unset( $columns['taxonomy-aec_categories'] );
	 	...
	 	foreach( $columns as $key => $value ) {
	  		if( 'author' == $key ) {
				if( ! empty( $general_settings['has_categories'] ) ) $n_columns['taxonomy-aec_categories'] = __( 'Categories', 'another-events-calendar' );
