...
class AEC_Admin_Settings {
	...
	function register_general_settings( $page_hook ) { 
		...
		add_settings_field( 
			'aec_general_settings[has_categories]',
    		__( 'Enable Categories', 'another-events-calendar' ),
    		array( $this, 'callback_checkbox' ),
    		$page_hook,
    		'aec_general_settings_section',
			array(
				'option_name' => 'aec_general_settings',
				'field_name'  => 'has_categories',
				'field_label' => __( 'Check this to enable categories', 'another-events-calendar' )
		...
		add_settings_field( 
			...
			array(
				...
				'options'     => array(
					...
					'map'    => __( 'Map view', 'another-events-calendar' )						
				),
				'description' => __( 'You must select at least one view.', 'another-events-calendar' )
			)
		);
